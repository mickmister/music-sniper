  ...
  if (editing) {
    actionButtons = (
      <div className={styles.actionButtons}>
        <Button className={styles.cancelButton} onClick={resetDraft}>{'Cancel'}</Button>
        <Button disabled={!draft} className={styles.saveButton} onClick={saveDraft}>{'Save'}</Button>
      </div>
    )
  }
  else {
    actionButtons = (
      <div className={styles.actionButtons}>
        ...
        {comment.id && <Button className={styles.editButton} onClick={deleteComment}>{'Delete'}</Button>}
      </div>
    )
  }
